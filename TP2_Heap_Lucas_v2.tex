...
\begin{Representacion}
  ...
  9) La longitud de la rama más corta de un nodo debe ser uno más que la longitud de la rama más corta del subárbol derecho. \\
  10) La longitud de la rama más larga de un nodo debe ser uno más que la longitud de la rama más larga del subárbol izquierdo. \\
  ...
  \noindent Invariante de representación: \\
  1) $siguiente$ apunta a $NULL$ si el $heap$ apunta a una cola vacia.\\
