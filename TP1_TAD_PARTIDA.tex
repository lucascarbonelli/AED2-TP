...
\tadOperacion{capturados}{jugador, partida, coordenada}{conj(pokemon)}{}
\tadOperacion{capturadosTotales}{partida, conj(coordenada), conj(pokemon)}{conj(pokemon)}{}
\tadOperacion{pokeCapturar}{conj(pokemon), jugador, coordenada, partida}{conj(coordenada)}{}
\tadOperacion{coordenadasTotalesPoke}{conj(pokemon), partida}{conj(coordenada)}{}
\tadOperacion{hayAlgunPoke}{jugador, conj(coordenada)}{bool}{}
\tadOperacion{movOK}{jugador, jugador, partida}{bool}{}
\tadOperacion{coordPoke}{jugador, conj(coordenada)}{coordenada}{}
\tadOperacion{esElElegido}{jugador, partida}{bool}{}
\tadOperacion{jugadoresEnRangoPoke}{coordenada, conj(jugador), partida}{conj(jugador)}{}
\tadOperacion{esePokemon}{jugador, partida}{pokemon}{}
\tadOperacion{cualEsEsePokemon?}{coordenada, conj(pokemon), partida}{pokemon}{}

\tadOperacion{pokeParaCapturar}{jugador/j, partida}{bool}{}
\tadOperacion{NoEliminados}{partida}{conj(jugador)}{}
\tadOperacion{FiltrarEliminados}{conj(jugador), partida}{conj(jugador)}{}
\tadOperacion{pokesCapturados}{conj(jugador), pokemon, partida}{nat}{}
\tadOperacion{pokesTotalesDeTipo}{pokemon, partida}{nat}{}
\tadOperacion{pokesTotalesJugadores}{conj(jugador), partida}{nat}{}
...
\tadAxioma{pokemonesDeJugador(mover(P, j', c),j)}{\IF j$\neq$j' $\land$ hayAlgunPoke(j, coordenadasTotalesPoke(pokemonesSalvajes(P), P)) $\yluego$ movOK(j, j', P) $\yluego$ pokeParaCapturar(j, P) $\yluego$ esElElegido(j, P) THEN Ag(esePokemon(j, P), pokemonesDeJugador) ELSE pokemonesDeJugador(j, P) FI }
...
\tadAxioma{capturadosTotales(p, C, C')}{\IF $\emptyset$?(C') THEN $\emptyset$ ELSE {\IF $\emptyset$?(posicionesPokemon(dameUno(C'), p) - C) THEN Ag(dameUno(C'),\\ capturadosTotales(C, sinUno(C'))) ELSE capturadosTotales(C, sinUno(C')) FI} FI}
