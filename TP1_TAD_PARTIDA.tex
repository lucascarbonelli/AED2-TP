...
\tadOperacion{capturados}{jugador/j, partida/p, coordenada}{conj(pokemon)}{j $\in$ jugadores(p) $\land$ $\neg$ eliminado(p,j)}
...
\tadOperacion{pokemonesCapturables}{conj(pokemon), jugador, coordenada, partida}{conj(coordenada)}{}
\tadOperacion{coordenadasTotalesPoke}{conj(pokemon), partida}{conj(coordenada)}{}
\tadOperacion{hayPokeEnRango}{jugador, conj(coordenada), partida}{bool}{}
\tadOperacion{movFueraDelPoke}{jugador, jugador, partida, coordenada}{bool}{}
...
\tadOperacion{div}{nat, nat}{nat}{}
\tadOperacion{mod}{nat, nat}{nat}{}
